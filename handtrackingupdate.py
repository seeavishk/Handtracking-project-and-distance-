...
while True:
    ...
    if hands:
        ...
        if len(hands) == 2:
            ...
            # Calculate and display distance between hands
            distance = ((centerPoint1[0] - centerPoint2[0]) ** 2 + (centerPoint1[1] - centerPoint2[1]) ** 2) ** 0.5
            cv2.putText(img, f"Distance: {int(distance)}", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 255), 2)
